...
### Changed
- ci: only release on semver tags and skip dependency submission on PRs
- build: add unit test suite and harden the fat JAR
- fix: valid jq paths, non-blocking autocomplete, and clean unload

[1.1.0]: https://github.com/bakirrayan/JSON_Tree_JQ/compare/1.0.5...1.1.0

## [1.0.5] - 2026-03-23

### Changed
- adding copy for jq and python path

[1.0.5]: https://github.com/bakirrayan/JSON_Tree_JQ/compare/1.0.4...1.0.5

## [1.0.4] - 2026-03-23

### Changed
- adding python path to the status bar

[1.0.4]: https://github.com/bakirrayan/JSON_Tree_JQ/compare/1.0.3...1.0.4

## [1.0.3] - 2026-03-20

### Changed
- added back the images in the assets folder
- changed images path to have less bloat of the main folder

[1.0.3]: https://github.com/bakirrayan/JSON_Tree_JQ/compare/1.0.2...1.0.3
